...
static const uint8_t LINES_PER_FRAME = 154;
static const int16_t TICKS_PER_LINE = 456;
static const uint8_t YRES = 144;
static const uint8_t XRES = 160;
